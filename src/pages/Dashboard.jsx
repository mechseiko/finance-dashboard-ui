...
export default function Dashboard() {
  ...
  const percentage = ((stats.balance / stats.income) * 100 || 0).toFixed(1);
  let remark = "";
  if (percentage === 100) {
    remark =
      "Outstanding performance! Keep it up.";
  } else if (percentage >= 80) {
    remark = "Great job! Keep it up.";
  } else if (percentage >= 50) {
    remark = "That's good, you can do better!";
  } else {
    remark = "You need to save more. Don't give up!";
  }
  return (
    <div className="p-6 lg:p-8 max-w-7xl mx-auto space-y-8">
      ...
      <div className="glass-card p-6 bg-brand-secondary/5 border-brand-secondary/20 text-white">
        <div className="flex items-start gap-4">
          <div className="p-3 bg-brand-secondary text-white rounded-xl">
          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3">
              ...
              <div className="flex items-center gap-2 p-3 bg-white dark:bg-slate-800 rounded-xl shadow-sm">
                <span className="text-xl">💰</span>
                <p className="text-sm">
                  You've saved <span className="font-bold text-emerald-500">{percentage}%</span> of your income this month. {remark}
                </p>
              </div>
            </div>
          </div>
